...
const RestaurantCard = (props) => {
  ...
  return (
    <div data-testid="resCard" className="bg-white shadow-md rounded-lg overflow-hidden w-full sm:w-80 m-2 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
