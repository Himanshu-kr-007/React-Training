...
const Body = () => {
  ...
  return listofRestaurants.length === 0 ? (
    ...
    <div>
      {/* User Input Section */}
      <div className="search-bar flex justify-end items-center m-2">
        <label className="mx-2 font">Set UserName</label>
        <input
          type="text"
      ...
      <div className="top-rated-restaurant text-center mb-6">
        <button
          className="top-rated-restaurant-button bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500"
